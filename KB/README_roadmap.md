...
Статус: открытый. При выполнении задачи — обновлять статус, дату и ссылаться на коммит/PR.
...
### 1. Внедрить автоматизированное тестирование критических путей
...
### 2. Разбить монолит bridge-plugin.ts
...
1. При начале работы над задачей — обновить статус в этом файле (In Progress) + дата.
2. После завершения — отметить ✅, добавить ссылку на коммит или PR, обновить связанные KB (README_architecture, INDEX и т.д.).
3. Раз в 1–2 месяца — ревью приоритетов.
4. Крупные архитектурные решения — фиксировать в отдельных README (по правилам KB).
