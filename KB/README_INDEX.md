...
10. [Оценка проекта и roadmap](#10-оценка-проекта-и-roadmap)
11. [Правила ведения KB](#правила-ведения-kb)
...
## 10. Оценка проекта и roadmap

| Файл | Описание | Ключевые темы | Актуализация |
|------|----------|---------------|--------------|
| [README_project_evaluation.md](./README_project_evaluation.md) | Оценка проекта и roadmap | Состояние проекта, приоритеты, план развития | 2026-06-12 |
