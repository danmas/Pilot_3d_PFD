...
*   [README_ideas.md](./README_ideas.md) — Идеи: реалистичный ландшафт, масштабирование сферы
*   [README_aircraft3d_scene.md](./README_aircraft3d_scene.md) — Размеры и объекты сцены, World Units
*   [../src/components/Instruments/aircraft3d/README_aircraft3d.md](../src/components/Instruments/aircraft3d/README_aircraft3d.md) — Полная документация компонента
