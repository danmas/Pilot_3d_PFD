...
let RealScene = null;
{
  RealScene = reactExports$1.lazy(() => __vitePreload(() => import("./RealAircraft3DScene-CslO-GMy.js"), true ? [] : void 0).then((m) => ({ default: m.RealAircraft3DScene })));
}
...
const Aircraft3DInstrument = React.lazy(() => __vitePreload(() => import("./LazyAircraft3DInstrument-OmoIP8S2.js"), true ? [] : void 0));
